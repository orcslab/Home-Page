...
**Syllabus**:  Introduction to the scientific method and the role of experimentation. Principles of experimental design. Simple comparative experiments. One-way ANOVA. Blocking and factorial experiments. Nonparametric methods. Multiple hypotheses testing. Effect sizes. Sample size calculations.  
**Schedule**: Offered twice a year.  
**Language**: English (first term) and Portuguese (second term).  
**More Information**:  [Course FAQ](index.php?option=com_content&view=article&id=54).  
**Course Materials**: [GitHub Repo](https://github.com/fcampelo/Design-and-Analysis-of-Experiments)
